...
<div class="wp1s-slide-meta-option-wrap">
    ...
    <div class="wp1s-slide-option-field">
        <input type="text" id="wp1s-slide-option-width" class="wp1s-slide-option-width" name="wp1s_slide_option_width"  value="<?php if ( ! empty ( $wp1s_stored_meta_option['wp1s_slide_option_width'] ) ) {
        echo esc_attr( $wp1s_stored_meta_option['wp1s_slide_option_width'][0] );
                } else{ echo 100;} ?>"/>         
            <p class="wp1s-slide-option-description"><?php esc_html_e("Width is set in %. Please enter the width not more than 100.") ?></p>          
    </div>
    </div> 
    <div class="wp1s-slide-option-wrapper">
    ...
    <div class="wp1s-slide-option-field">
		...
		echo esc_attr( $wp1s_stored_meta_option['wp1s_slide_option_speed'][0] );
         ...
         <p class="wp1s-slide-option-description"><?php esc_html_e("Enter the duration between each slide transition in milisecond.") ?></p>
    </div>
    </div> 
     <div class="wp1s-slide-option-wrapper">
    ...
    <div class="wp1s-slide-option-field">
        ...
        <p class="wp1s-slide-option-description"><?php esc_html_e("Enter the duration of transition animation in milisecond.") ?></p>
    </div>
    </div> 
    ...
    <div class="wp1s-slide-option-field">
        ...
        <p class="wp1s-slide-option-description"><?php esc_html_e("Select true if you want to enable auto transition of slides") ?></p>
    </div>
    </div> 
    <div class="wp1s-slide-option-wrapper">
    ...
    <div class="wp1s-slide-option-field">
        ...
        <p class="wp1s-slide-option-description"><?php esc_html_e("Select the type of transition for the slides.") ?></p>
    </div>
    </div> 
    <div class="wp1s-slide-option-wrapper">
    ...
    <div class="wp1s-slide-option-field">
        ...
        <p class="wp1s-slide-option-description"><?php esc_html_e("Select true if you want \"Next\" / \"Prev\" controls for the slider.") ?></p>
    </div>
    </div>
    	<div class="wp1s-slide-option-wrapper">
        ...
        <p class="wp1s-slide-option-description"><?php esc_html_e("Select true if you want slider to be reponsive in mobile.") ?></p>
      </div>
      </div>  
</div>