				...
				<div class="meta-box-sortables">
					<div class="postbox">
						<div class="postbox-header">
							<h2 class="hndle">
								<span><?php _e( 'Need Support & Solutions?', 'wp-logo-showcase-responsive-slider-slider' ); ?></span>
							</h2>
						</div>
						<div class="inside wpos-clearfix">
							<div class="wpos-col">
								<div class="wpos-box">
									<h5 style="font-size: 18px;line-height: 30px;margin: 10px 0px; background:#0055fb;">Logo Showcase Premium Features</h5>
									<h4>Single Plugin</h4>
									<ul class="wpos-list">
										<li><b>15+ predefined template</b> for logo showcase.</li>
										<li><b>3 shortcodes</b> [logoshowcase], [logo_grid] and [logo_filter]</li>
										<li>Drag &amp; Drop order change</li>
										<li>Display logo showcase in a <b>grid view.</b></li>
										<li>Display <b>logo with filtration</b>.</li>
										<li>Display logo showcase in <b>slider view</b></li>
										<li><a href="<?php echo WPLS_PLUGIN_LINK_UPGRADE; ?>" target="_blank">View More All Features</a></li>
									</ul>
									<div style="text-align:center;">
										<a class="button button-primary button-blue" href="<?php echo WPLS_PLUGIN_LINK_UPGRADE; ?>" target="_blank"><?php _e('Grab Now', 'wp-logo-showcase-responsive-slider-slider'); ?></a>
									</div>
								</div>
							</div>
							<div class="wpos-col">
								<div class="wpos-box">
									<h5 style="font-size: 18px;line-height: 30px;margin: 10px 0px; background:#ff5d52;">Essential Bundle With Logo Showcase</h5>
									<h4>Bundle Deal</h4>
									...
									<div style="text-align:center;">
										<a class="button button-primary button-orange" href="<?php echo WPLS_PLUGIN_BUNDLE_LINK; ?>" target="_blank"><?php _e('Grab Now', 'wp-logo-showcase-responsive-slider-slider'); ?></a>
									</div>
								</div>
							</div>
							<div class="wpos-clearfix">
								<img src="<?php echo WPLS_URL; ?>/assets/images/page-builder-support.jpg" style="max-width:100% " />
							</div>
						</div><!-- .inside -->
					</div><!-- #general -->
				...
				<div class="meta-box-sortables">
					<div class="postbox wpos-pro-box">
						...
						<div class="inside">
							...
							<a class="button button-primary wpos-button-full button-orange" href="<?php echo WPLS_PLUGIN_LINK_UPGRADE; ?>" target="_blank"><?php _e('Grab Logo Showcase Now', 'wp-logo-showcase-responsive-slider-slider'); ?></a>
						</div><!-- .inside -->
					</div><!-- #general -->
				</div><!-- .meta-box-sortables -->
