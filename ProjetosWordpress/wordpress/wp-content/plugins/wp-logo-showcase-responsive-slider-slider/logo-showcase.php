...
if( !defined( 'WPLS_VERSION' ) ) {
	define( 'WPLS_VERSION', '3.0.7' ); // Version of plugin
}
...
if(!defined( 'WPLS_PLUGIN_BUNDLE_LINK' ) ) {
	define('WPLS_PLUGIN_BUNDLE_LINK','https://www.essentialplugin.com/wordpress-plugin/wp-logo-showcase-responsive-slider/?utm_source=WP&utm_medium=Logoshowcase&utm_campaign=Bundle-Banner#wpos-epb'); // Plugin link
}

if(!defined( 'WPLS_PLUGIN_LINK_UNLOCK' ) ) {
	define('WPLS_PLUGIN_LINK_UNLOCK','https://www.essentialplugin.com/wordpress-plugin/wp-logo-showcase-responsive-slider/?utm_source=WP&utm_medium=Logoshowcase&utm_campaign=Features-PRO'); // Plugin link
}

if(!defined( 'WPLS_PLUGIN_LINK_UPGRADE' ) ) {
	define('WPLS_PLUGIN_LINK_UPGRADE','https://www.essentialplugin.com/wordpress-plugin/wp-logo-showcase-responsive-slider/?utm_source=WP&utm_medium=Logoshowcase&utm_campaign=Upgrade-PRO'); // Plugin Check link
}
